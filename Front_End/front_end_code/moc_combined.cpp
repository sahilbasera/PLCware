...
const QMetaObject combined::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_combined.data,
      qt_meta_data_combined,  qt_static_metacall, nullptr, nullptr}
};
...
void *combined::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_combined.stringdata0))
        return static_cast<void*>(const_cast< combined*>(this));
